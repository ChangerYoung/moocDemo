				...
				<div role="tabpanel" class="tab-pane active" id="myCreated">
					<c:forEach var="course" items="${course_list}">
						<div class="tclass-line">
							<div class="left"><a href="#"><img src="../upload/${course.picurl}" alt=""></a></div>
							<div class="right">
								<button class="btn-click"><i class="fa fa-location-arrow"></i></button>
								<div class="hide-field">
									<a href="addCourse?courseId=${course.courseid}" class="link-1"><i class="fa fa-edit"></i>编辑课程</a>
									<a href="deleteCourse?courseId=${course.courseid}" class="link-1"><i class="fa fa-trash-o"></i>删除课程</a>
									<a href="addChapter?courseId=${course.courseid}" class="link-1"><i class="fa  fa-plus-circle "></i>章节管理</a>
								</div>
							</div>
							<div class="middle">
